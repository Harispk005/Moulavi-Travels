    ...
    return (
        <div>
            ...
            <div className="md:grid grid-cols-1 md:grid-cols-2">
                <div >
                    <div className="flex items-center gap-2 px-8 md:px-0 md:ml-60">
                    ...
                    <div className="hidden md:block md:mt-25 md:absolute">
                        <img src={img} alt="Preview" className="h-[400px] w-[350px]" />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 px-8 mt-8 md:px-0 md:ml-10">
                    ...
                    <div className='flex items-center gap-2 md:mt-[20px] md:ml-10 justify-center'>
                        <button className='bg-[#371275] text-[#FFBD05] w-[150px] h-[40px] rounded-[5px] hover:bg-[#371280] ml-15 md:ml-0'>SEND</button>
                    </div>
            ...
            <div className="md:hidden absolute ">
                        <img src={img} alt="Preview" className="h-[300px] w-[250px]" />
                    </div>

            <div className='mt-50 md:mt-[30px]'>
                <img src={bg} alt='' className='w-full h-[170px] object-fill'/>
            </div>
