        ...
        <div className="relative bg-[#FFBD05] min-h-screen">
            ...
            <div className='flex flex-col py-10  w-full bg-[#371275] '>
                ...
                <div className='flex flex-col p-4 max-w-7xl mx-auto  w-full mt-4'>
                    ...
                    <h2 className={`${inknutAntiqua.className} mt-4 text-3xl text-[#FFBD05] `}>WHY CHOOSE MOULAVI?</h2>
                    <div className='flex flex-col lg:flex-row gap-4 lg:gap-8 mt-4'>
                        ...
                        <Image src={tick} alt="tick" width={300} height={300} className="critical-media" priority />
                    </div>
                </div>
            </div>
