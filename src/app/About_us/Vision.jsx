...
const Vision = () => {
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center min-h-screen p-2">
      ...
      <div className=" py-5 mt-3 md:px-0 md:py-0 md:mt-0 h-screen bg-[#371275]">
        <div className='p-3 md:p-10'>
          ...
          <h1 className={`text-[#FFBD05] text-lg md:text-3xl font-semibold mt-5 ${inknutAntiqua.className}`}>Services Beyond Commitments</h1>

          <div className="flex flex-col md:flex-row items-center justify-center mt-10 gap-6">
            <Image
              src={vision}
              alt="Vision Image"
              className="w-[350px] md:w-[450px] h-auto rounded-lg"
            />

            <div className="bg-[#371275] md:p-6 rounded-xl w-[90%] md:w-[680px]">
              <p className={`text-[#FFBD05] text-sm md:text-lg text-justify font-semibold ${inter.className}`}>
        ...
        <div className='p-3 md:p-10'>
          ...
          <h1 className={`text-[#FFBD05] text-lg md:text-3xl font-semibold mt-5 ${inknutAntiqua.className}`}>Trusted Immigration and Visa Advice</h1>
